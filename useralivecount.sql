...
SELECT
	...
	FROM
		...
		AND
		a1.schoolid NOT in ('0','900090009','3563','3618','4160')
	...
	LEFT JOIN (
		...
		AND a2.schoolid NOT in ('0','900090009','3563','3618','4160')
		GROUP BY
			a2.schoolid,
			a2.gradename
...
AND sta1.gradename=sta2.gradename
	LEFT JOIN (
		SELECT a5.schoolid,a5.gradename,sum(a5.teanum)AS teanum 
			...
			AND
			a3.schoolid NOT in ('0','900090009','3563','3618','4160')
			GROUP BY
...
AND sta1.gradename = sta3.gradename
	...
	AND
		a2.schoolid NOT in ('0','900090009','3563','3618','4160')
	GROUP BY
		a2.schoolid,
		a2.schoolname,
		a2.gradename
	...
	LEFT JOIN (
		...
		AND 
			a4.schoolid NOT in ('0','900090009','3563','3618','4160')
		GROUP BY
			a4.schoolid,
			a4.schoolname,
			a4.gradename
